...
public class TelaCadastroAdministrador extends javax.swing.JFrame {
    ...
    public TelaCadastroAdministrador() throws SQLException {
        initComponents();
    ...
    private void txtCEPKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCEPKeyReleased
        ...
        if (txtCEP.getText().length() == 8) {
            try {
                ...
                Logger.getLogger(TelaCadastroAdministrador.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void BotaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoCadastrarActionPerformed
        ...
        try (Connection connection = conexaoBanco.getConnection()) {
            ...
            // Verificando se o CPF ou nome já existem
            ...
            // Salvar as informações do novo administrador com o boolean 'administrador' como true
            String gravamentoDeDados = "INSERT INTO `banco`.`usuario` (`nome`, `senha`, `cpf`, `telefone`, `cep`, `rua`, `numero`, `bairro`, `cidade`, `estado`, `administrador`) "
            + "VALUES('" + nome + "', '" + senha + "', '" + cpf + "', '" + telefone + "', '" + cep + "', '" + rua + "', '" + numero + "', '" + bairro + "', '" + cidade + "', '" + estado + "', true)";
            ...
            try {
                ...
                JOptionPane.showMessageDialog(rootPane, "Ocorreu um erro ao cadastrar o administrador: " + ex.getMessage());
            }
        } catch (SQLException ex) {
